	...
	function handleClarifyConfirm() {
		editTask(task.id, {
			...
			...(selectedDuration !== undefined
				? { estimatedMinutes: selectedDuration ?? undefined }
				: {}),
		})
		advance()
	}
								...
								<Group gap="xs">
									{AREAS.map((a) => (
										<Button
											...
											color="blue"
											onClick={() =>
												setSelectedArea(selectedArea === a ? null : a)
											}
										>
											{t(`area.${a}`)}
										</Button>
								...
								<Group gap="xs">
									{CONTEXTS.map((c) => (
										<Button
											...
											color="teal"
											onClick={() =>
												setSelectedContext(selectedContext === c ? null : c)
											}
										>
											{t(`context.${c}`)}
										</Button>
								...
								<Group gap="xs">
									{DURATIONS.map(({ label, value }) => (
										<Button
											...
											onClick={() =>
												setSelectedDuration(
													selectedDuration === value ? undefined : value,
												)
											}
										>
											{t(label)}
